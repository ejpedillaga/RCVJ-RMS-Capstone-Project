...
WHERE reg_date >= CURDATE() - INTERVAL 7 DAY"; //For last 7 days
...
<head>
    ...
    <title>Admin Dashboard | RCVJ Inc.</title>
...
<body>
    ...
    */
    ...
    createBarChart('#ael-bar-chart', <?php echo $avgExperienceYearsJson;?>, <?php echo $jobTitlesJson;?>, 'Average Job Experience in Years')
